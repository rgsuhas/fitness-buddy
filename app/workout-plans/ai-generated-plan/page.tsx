        ...
        const mockWorkoutPlan: WorkoutPlan = {
          ...
          schedule: [
              ...
              exercises: [
                {
                  ...
                  reps: "6-8",
                  rest: "2-3 minutes",
                  notes: "Focus on controlled eccentric (lowering) phase",
                },
                {
                  id: "ex2",
                  ...
                  reps: "8-10",
                  rest: "90 seconds",
                  notes: "Keep core tight and avoid excessive arching",
                },
                {
                  id: "ex3",
            ...
            },
            {
              ...
              cooldown: [],
              notes:
                "Active recovery options: 20-30 minute walk, light yoga session, or mobility work. Focus on getting quality sleep and proper nutrition.",
            },
            {
              day: "day4",
              ...
              exercises: [
                {
                  ...
                  reps: "6-10",
                  rest: "2 minutes",
                  notes: "Use assistance if needed to complete the rep range",
                },
                {
                  id: "ex12",
                ...
                },
                {
                  ...
                  reps: "12-15",
                  rest: "60 seconds",
                  notes: "Focus on external rotation at the end of the movement",
                },
              ],
              cooldown: [
                ...
                <CardContent className="space-y-6">
                      ...
                      <table className="w-full border-collapse">
                        <thead>
                          <tr className="border-b">
                            ...
                            <th className="text-center py-2 px-4">Rest</th>
                        ...
                        <tbody>
                          {day.exercises.map((exercise) => (
                            <tr key={exercise.id} className="border-b">
                              ...
                              <td className="py-3 px-4 text-muted-foreground">{exercise.notes || "-"}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
                  ...
                  {day.notes && (
                    <div className="p-4 bg-muted rounded-lg">
                      <p className="text-sm italic">{day.notes}</p>
                    </div>
                  )}
                </CardContent>
              ) : (
